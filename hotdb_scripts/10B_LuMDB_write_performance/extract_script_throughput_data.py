...
# 使用示例
log_file_path = '/home/jeff-wang/WorkloadAnalysis/hotdb_scripts/10B_hotDB/A2PLaTDB_10B_val_128_mem1MB_zipf1.5.log'  # 替换为您的日志文件路径

extracted_data = extract_ops_per_second_data(log_file_path)

# 使用示例
output_file_path = f'/home/jeff-wang/WorkloadAnalysis/hotdb_scripts/10B_hotDB/A2PLaTDB_1.5_throughput_output.txt'  # 替换为您想保存结果的文件路径
