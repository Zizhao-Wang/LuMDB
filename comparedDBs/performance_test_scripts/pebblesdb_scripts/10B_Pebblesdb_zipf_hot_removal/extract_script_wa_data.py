...
# 使用示例
log_file_path = '/home/jeff-wang/WorkloadAnalysis/comparedDBs/performance_test_scripts/pebblesdb_scripts/10B_Pebblesdb_zipf_hot_removal/Pebbles10B_10B_val_128_mem8MB_zipf1.3.log'  # 替换为您的日志文件路径
...
# 使用示例
output_file_path = f'/home/jeff-wang/WorkloadAnalysis/comparedDBs/performance_test_scripts/pebblesdb_scripts/10B_Pebblesdb_zipf_hot_removal/Pebblesdb_mem8MiB_1.3waoutput.txt'  # 替换为您想保存结果的文件路径
