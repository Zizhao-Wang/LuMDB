...
# 使用示例
log_file_path = '/home/jeff-wang/WorkloadAnalysis/comparedDBs/performance_test_scripts/leveldb_scripts/10B_leveldb_zipf_hc/leveldb2_10B_val_128_zipf1.3_1-30.log'  # 替换为您的日志文件路径
...
# 使用示例
output_file_path = f'/home/jeff-wang/WorkloadAnalysis/comparedDBs/performance_test_scripts/leveldb_scripts/10B_leveldb_zipf_hc/mem64MiB_waoutputfile1.3.txt'  # 替换为您想保存结果的文件路径
