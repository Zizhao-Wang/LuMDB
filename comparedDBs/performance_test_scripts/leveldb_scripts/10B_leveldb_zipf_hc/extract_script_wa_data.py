...
# 使用示例
output_file_path = f'/home/jeff-wang/WorkloadAnalysis/comparedDBs/performance_test_scripts/leveldb_scripts/10B_leveldb_zipf_hc/extract_wa_data_floder/zipf1.1/outputfile1.1.txt'  # 替换为您想保存结果的文件路径
