    ...
    if [ ! -d "$dir1" ]; then
        ...
        for value_size in 128; do
            ...
            for zipf_a in 1.2; do  # 1.2 1.3 1.4 1.5
                ...
                ycsb_data_file="/home/jeff-wang/workloads/ycsb_d_workload.csv" # 构建数据文件路径
