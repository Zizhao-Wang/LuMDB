...
# 使用示例
log_file_path = '/home/jeff-wang/WorkloadAnalysis/comparedDBs/performance_test_scripts/Rocksdb_scripts/10B_RocksDB_zipf_hot_removal/RocksDB_10B_val128_mem64MB_zipf1.3.log'  # 替换为您的日志文件路径
...
output_file_path = f'/home/jeff-wang/WorkloadAnalysis/comparedDBs/performance_test_scripts/Rocksdb_scripts/10B_RocksDB_zipf_hot_removal/RocksDB_mem64MiB_1.3waoutput.txt'  # 替换为您想保存结果的文件路径
