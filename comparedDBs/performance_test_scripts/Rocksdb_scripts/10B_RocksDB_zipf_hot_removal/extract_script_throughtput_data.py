...
# 使用示例
log_file_path = '/home/jeff-wang/WorkloadAnalysis/comparedDBs/performance_test_scripts/Rocksdb_scripts/10B_RocksDB_zipf_hot_removal/RocksDB_10B_val128_mem1MB_zipf1.4.log'  # 替换为您的日志文件路径

extracted_data = extract_ops_per_second_data(log_file_path)

# 使用示例
output_file_path = f'/home/jeff-wang/WorkloadAnalysis/comparedDBs/performance_test_scripts/Rocksdb_scripts/10B_RocksDB_zipf_hot_removal/Rocksdb_1.4_throughput_output.txt'  # 替换为您想保存结果的文件路径
