...
directories = {
    'mp4004TB_fio_test_read_ranseq': r'read: IOPS=(\d+\.?\d*)(k?), BW=(\d+\.?\d*)(KiB/s|MiB/s) \((\d+\.?\d*)(kB/s|MB/s)\)\((\d+\.?\d*)(MiB|GiB|KiB)/(\d+)msec\)',
    'mp4004TB_fio_test_write_ranseq': r'write: IOPS=(\d+\.?\d*)(k?), BW=(\d+\.?\d*)(KiB/s|MiB/s) \((\d+\.?\d*)(kB/s|MB/s)\)\((\d+\.?\d*)(MiB|GiB|KiB)/(\d+)msec\)'
}
