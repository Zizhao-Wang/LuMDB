...
./AcerN3500_disk_fio_read_test_script.sh

# 运行读写测试脚本
echo "Running read-write test script..."
./AcerN3500_disk_fio_read_write_script.sh


# 运行写测试脚本
echo "Running write test script..."
./AcerN3500_disk_fio_write_test_script.sh


# 运行读测试脚本
echo "Running read with multi-queue script..."
./AcerN3500_disk_fio_read_multiqueue_scripts.sh
