...
million = 1000  # 1 Million for testing
num_keys = 9999999999999999999  
...
def generate_keys_uniform(num_keys, keys_file_name):
    keys = uniform.rvs(size=million, loc=num_keys, scale=num_keys+100000)  # 在 [0, num_keys] 范围内生成均匀分布数据
...
# 使用均匀分布生成数据
uniform_file_name = f'/home/jeff-wang/workloads/uniform_read_keys{key_size}_value{val_size}_1Thousand_noexists.csv'
