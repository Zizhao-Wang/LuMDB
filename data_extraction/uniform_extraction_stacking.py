...
# 用于示例的日志文件目录和输出目录
log_dir = '/home/wangzizhao/WorkloadAnalysis/scripts/2B_leveldb_uniform/divider_1'  # 确保这是您的日志文件目录
output_dir = '/home/wangzizhao/WorkloadAnalysis/data_extraction/uniform_extraction'  # 确保这是您的输出目录
